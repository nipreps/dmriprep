...
export default {
    ...
    methods: {
        ...
        updateHighlightPoints() {
            var self = this;
            d3.select(`#${this.id} .dot-series-1`).attr('r', 7).attr('cx', function(){
                console.log('ud')
            ...
            d3.select(`#${this.id} .dot-series-2`).attr('r', 7).attr('cx', function(){
                return self.x(self.highlightIdx)
            }).attr('cy', function(){
        ...
        plotData() {
            ...
            const minX = d3.min(this.data, function(d, i){return i})
            const maxX = d3.max(this.data, function(d, i){return i})

            const maxY = d3.max(this.data, function(d, i){return d3.max(d)})
            const minY = d3.min(this.data, function(d, i){return d3.min(d)})
            ...
            const line1 = d3.line()
                         ...
                         .y(function(d, i) { return self.y(d[0]); });
